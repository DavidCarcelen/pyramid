...
-- STORES
INSERT INTO stores (id, email, password, nickname, profile_picture, address)
VALUES
    ('7b6f44b5-9c28-4a45-bc26-67c2f5d43101', 'serpi@example.com', '$2a$10$XY8nPLIhCQRsdg6kxb8Zp.2UHyXmh6QxJ3VLLJQopKvN4u2jRnFBi', 'Serpi', 'profilePicture', 'ali bei'),
    ...
    ('de4e8a9c-0463-4c7e-b5a7-589d08c15a03', 'hamelin@example.com', '$2a$10$XY8nPLIhCQRsdg6kxb8Zp.2UHyXmh6QxJ3VLLJQopKvN4u2jRnFBi', 'Hamelin', 'UnaRata', 'mataro'),
    ('f8e3d67a-918c-45a8-8bbf-82d1d0d45c04', 'elnucli@example.com', '$2a$10$XY8nPLIhCQRsdg6kxb8Zp.2UHyXmh6QxJ3VLLJQopKvN4u2jRnFBi', 'ElNucli', 'noPicture', 'sants'),
    ('c1a92c11-63d2-4e76-9fdc-c0d82e4dcf05', 'magicbcn@example.com', '$2a$10$XY8nPLIhCQRsdg6kxb8Zp.2UHyXmh6QxJ3VLLJQopKvN4u2jRnFBi', 'MagicBCN', 'IMPERIUM', 'ronda sant Pau');

-- PLAYERS

INSERT INTO players (id, email, password, nickname, profile_picture)
VALUES
    ...
    ('b2a7b9f1-2c58-4b2b-b9d2-1a22f8baf222', 'miki@example.com', '$2a$10$XY8nPLIhCQRsdg6kxb8Zp.2UHyXmh6QxJ3VLLJQopKvN4u2jRnFBi', 'Miki', 'Picture'),
    ('c3b8c1a2-1d69-4c3c-9ae3-2b33f9caf333', 'pedro@example.com', '$2a$10$XY8nPLIhCQRsdg6kxb8Zp.2UHyXmh6QxJ3VLLJQopKvN4u2jRnFBi', 'Pedro', ''),
    ('d4c9d2b3-0e7a-4d4d-a8f4-3c44f0dbf444', 'deko@example.com', '$2a$10$XY8nPLIhCQRsdg6kxb8Zp.2UHyXmh6QxJ3VLLJQopKvN4u2jRnFBi', 'Deko', 'design'),
    ...
    ('f4e7c2a9-72b8-4b0c-a1df-5e8a9cc4de77', 'juan@example.com', '$2a$10$XY8nPLIhCQRsdg6kxb8Zp.2UHyXmh6QxJ3VLLJQopKvN4u2jRnFBi', 'Juan', 'mythic'),
    ...
    ('1e4f6c9d-8b2a-4f2e-9b33-7d4a1f5a9d60', 'pegaso@example.com', '$2a$10$XY8nPLIhCQRsdg6kxb8Zp.2UHyXmh6QxJ3VLLJQopKvN4u2jRnFBi', 'Pegaso', 'elGusano');
